using KampanyalıOyunSatisi.Concrete;
...
namespace KampanyalıOyunSatisi
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            saleManager.CampaignSale(new Gamer() {FirstName="Kaya" }, new Game() {GameName="GameOfThrones" }, new Campaign()
            {CampaignName="AltinKampanya"});
